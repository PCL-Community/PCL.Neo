...
public class RotateTransformAngleAnimation : IAnimation
{
    ...
    public RotateTransformAngleAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double valueAfter) :
        this(
            control, duration, delay, valueAfter, new LinearEasing())
    {
    }

    public RotateTransformAngleAnimation(Animatable control, TimeSpan duration, double valueAfter, Easing easing) :
        this(
    ...
    public RotateTransformAngleAnimation(Animatable control, double? valueBefore, double valueAfter, Easing easing) :
        this(
            control, TimeSpan.FromSeconds(1), valueBefore, valueAfter, easing)
    {
    }

    public RotateTransformAngleAnimation(Animatable control, TimeSpan duration, double? valueBefore, double valueAfter)
        : this(
            control, duration, valueBefore, valueAfter, new LinearEasing())
    {
    }

    public RotateTransformAngleAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double? valueBefore,
