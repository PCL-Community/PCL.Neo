...
public class TranslateTransformXAnimation : IAnimation
{
    ...
    public TranslateTransformXAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double valueAfter) :
        this(
    ...
    public TranslateTransformXAnimation(Animatable control, double? valueBefore, double valueAfter, Easing easing) :
        this(
            control, TimeSpan.FromSeconds(1), valueBefore, valueAfter, easing)
    {
    }

    public TranslateTransformXAnimation(Animatable control, TimeSpan duration, double? valueBefore, double valueAfter) :
        this(
            control, duration, valueBefore, valueAfter, new LinearEasing())
    {
    }

    public TranslateTransformXAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double? valueBefore,
