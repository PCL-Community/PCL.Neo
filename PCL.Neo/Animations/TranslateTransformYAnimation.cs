...
public class TranslateTransformYAnimation : IAnimation
{
    ...
    public TranslateTransformYAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double valueAfter) :
        this(
    ...
    public TranslateTransformYAnimation(Animatable control, double? valueBefore, double valueAfter, Easing easing) :
        this(
            control, TimeSpan.FromSeconds(1), valueBefore, valueAfter, easing)
    {
    }

    public TranslateTransformYAnimation(Animatable control, TimeSpan duration, double? valueBefore, double valueAfter) :
        this(
            control, duration, valueBefore, valueAfter, new LinearEasing())
    {
    }

    public TranslateTransformYAnimation(Animatable control, TimeSpan duration, TimeSpan delay, double? valueBefore,
